...
class WorkoutPlannerApp(App):
    ...
    def generate_workout_plan(self, instance):
        ...
        try:
            ...
            while len(selected_exercises) < desired_num_exercises:
                ...
                total_workout_time_seconds += total_time_for_next_exercise  # New Line
            ...
            for idx in selected_exercises:
                ...
                for set_number in range(1, num_sets + 1):
                    ...
                    total_workout_time_seconds += rest_time_between_sets
            ...
            total_time_minutes = total_workout_time_seconds // 60  # Modified Line
            total_time_remaining_seconds = total_workout_time_seconds % 60  # Modified Line
            ...
            self.total_time_label = Label(text=f"Total Time for Workout: {total_time_minutes} minutes and {total_time_remaining_seconds} seconds",  # Modified Line
                                    size_hint_y=None, height=60)  # New Line
            summary_grid.add_widget(self.total_time_label)  # Modified Line
    ...
    def update_time_value(self, instance, value):
        ...
        self.recalculate_total_time()  # New Line
    ...
    def recalculate_total_time(self):  # New Method
        total_time_seconds = 0
        for exercise in self.workout_plan:
