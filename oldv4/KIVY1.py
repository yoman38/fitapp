...
class WorkoutPlannerApp(App):
    ...
    def generate_workout_plan(self, instance):
        try:
            ...
            self.output_label.text = f"Collected Data:\n{user_input_dict}\nRest Time: {user_rest_time}\nTraining Length: {total_training_length_minutes}\nDesired Exercises: {desired_num_exercises}\nTraining Goal: {user_training_goal}\nUnavailable Equipment: {unavailable_equipment}"

        except ValueError:
            self.output_label.text = "Invalid input. Please enter numbers."
