    ...
    def generate_workout_plan(self, instance):
        ...
        try:
            ...
            for exercise in selected_exercises:
                ...
                # Define weight and total_time_for_one_exercise here
                weight = exercise.get('weight', 'N/A')  # Get weight from the exercise dictionary, default to 'N/A' if not found
                total_time_for_one_exercise = exercise.get('time_per_set', 0) * num_sets  # Calculate total time for one exercise
